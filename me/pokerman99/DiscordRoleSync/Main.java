...
public class Main{
	...
	public void onPreInit(GameStartingServerEvent event) {
		...
		me.pokerman99.DiscordRoleSync.discord.Login(server);
		//Sponge.getEventManager().registerListeners(this, new serverInfoCommand());
		Sponge.getEventManager().registerListeners(this, new me.pokerman99.DiscordRoleSync.roleSync(this));
		...
		CommandSpec link = CommandSpec.builder().executor(new me.pokerman99.DiscordRoleSync.roleSync(this)).build();
	...
	public void onShutDown(GameStoppingEvent event){
		me.pokerman99.DiscordRoleSync.discord.Logout();
	}
